...
class SexualBehaviourData:
    ...
    def __init__(self, filename):
        ...
        self.baseline_risk = np.array(
            self._select_matrix(self.data["baseline_risk_options"]["risk_factor"]))
        ...
        self.init_sex_behaviour_probs = {
            SexType.Male: self._get_discrete_dist(["initial_sex_behaviour_probabilities", "Male"]),
