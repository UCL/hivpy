...
FIRST_ORAL_START_DATE = "first_oral_start_date"     # None | date: start date of first ever oral PrEP usage (DUMMY)
FIRST_CAB_START_DATE = "first_cab_start_date"       # None | date: start date of first ever injectable Cab PrEP usage (DUMMY)
FIRST_LEN_START_DATE = "first_len_start_date"       # None | date: start date of first ever injectable Len PrEP usage (DUMMY)
FIRST_VR_START_DATE = "first_vr_start_date"         # None | date: start date of first ever vaginal ring PrEP usage (DUMMY)
LAST_PREP_START_DATE = "last_prep_start_date"       # None | date: start date of most recent PrEP usage (DUMMY)
