...
PREP_INJ_PREF = "prep_inj_pref"                 # float: a value that determines and individual's preference for injectable (Cab or Len) PrEP
...
PREP_INJ_WILLING = "prep_inj_willing"           # Bool: True if an individual is willing to use injectable (Cab or Len) PrEP
