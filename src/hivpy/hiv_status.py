...
class HIVStatusModule:
    ...
    def initial_HIV_status(self, population):
        ...
        return pd.Series(False, population.data.index)
    ...
    def introduce_HIV(self, population):
        ...
        initial_candidates = population.data[col.NUM_PARTNERS] >= self.initial_hiv_newp_threshold
